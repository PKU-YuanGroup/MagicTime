...
[![GitHub repo size](https://img.shields.io/github/repo-size/PKU-YuanGroup/MagicTime?style=flat&logo=github&logoColor=whitesmoke&label=Repo%20Size)](https://github.com/PKU-YuanGroup/MagicTime/archive/refs/heads/main.zip)
...
* `[2024.04.13]`  🔥 We have compressed the size of the repository so that everyone can clone easier and faster.
