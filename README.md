...
* `[2024.04.10]`  🔥 We release the HuggingFace Space of MagicTime, you can [click](https://huggingface.co/spaces/BestWishYsh/MagicTime?logs=build) here to have a try.
